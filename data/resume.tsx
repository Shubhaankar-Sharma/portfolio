const RESUME = {
  ...
  avatar_path: "/me.webp",
  bio: {
    intro: "CS student at UBC researching Distributed Systems and ML",
  ...
  experience: [
    {
      ...
      //   </svg>
      // ),
      company: "Systopia Labs, University of British Columbia",
      role: "Research Intern",
      description: [
        "Working under Dr. Arpan Gujarati in collaboration with NVIDIA on real time systems research related to the Holoscan SDK (AI applications in Hospitals and Surgery Tables)",
        "This internship is supported by the Work Learn International Undergraduate Research Award",
      ],
      start_date: "May 2025",
      end_date: "",
      location: "Vancouver, BC",
      company_website: "https://systopia.cs.ubc.ca/",
      keywords: [
        "C++",
        "CUDA",
        "NVIDIA Holoscan SDK",
    ...
    },
    {
      ...
      description: [
        ...
        "Migrated DevOps stack to Kubernetes and Pulumi",
        "Built webhook notification service in Go for EVM chain events",
        "Developed Grafana-Prometheus dashboards for monitoring all microservices across multiple environments",
        "Maintained metadata service handling 1.5k requests/minute, serving and indexing metadata of blockchain assets",
        "Contributed to ethwal's filter index optimization, allowing search through millions of events in milliseconds",
      ],
      start_date: "Sep 2021",
      end_date: "Sep 2024",
      location: "Toronto, ON",
      company_website: "https://sequence.xyz",
      keywords: [
        "Go",
        "Kubernetes",
        "Pulumi",
  ...
  links: [
    {
      name: "Email",
      url: "mailto:shubhaankar@hotmail.com",
      text: "shubhaankar@hotmail.com",
    },
    {
      name: "GitHub",
      url: "https://github.com/Shubhaankar-Sharma",
      text: "Shubhaankar-Sharma",
    },
    {
      name: "Resume",
      url: "/resume.pdf",
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/shubhaankar-sharma/",
      text: "shubhaankar-sharma",
    },
    {
      name: "X",
      url: "https://x.com/__spongeboi",
      text: "__spongeboi",
    },
    {
      name: "Notes",
      url: "https://notes.spongeboi.com/",
      text: "notes.spongeboi.com",
    },
    {
      name: "Photography",
      url: "https://flickr.com/photos/spongeboi/albums/72177720327477170/",
      text: "Flickr Album",
    },
  ],
};
